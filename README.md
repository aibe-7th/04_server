...
* **[40](40)**: 4주차 강의 교안 (PDF)
  * [401-1_Spring Boot 4와 Gradle.pdf](40/401-1_Spring Boot 4와 Gradle.pdf): Spring Boot 스택, 내장 서버, Gradle 설정
  * [401-2_application-yml과 외부 설정.pdf](40/401-2_application-yml과 외부 설정.pdf): 외부화 설정, 우선순위, 프로파일, 값 주입, `.env` 설정
  * [401-3_Thymeleaf 기초.pdf](40/401-3_Thymeleaf 기초.pdf): SSR 개념, Thymeleaf 표현식, XSS 방지, 조건 및 반복문
